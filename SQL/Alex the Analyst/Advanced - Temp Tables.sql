...
-- Tabel sementara adalah tabel yang hanya dapat dilihat oleh sesi yang membuatnya.
-- Tabel ini dapat digunakan untuk menyimpan hasil sementara untuk kueri kompleks atau untuk memanipulasi data sebelum memasukkannya ke dalam tabel permanen.

-- Ada 2 cara untuk membuat tabel sementara:
-- 1. Ini adalah cara yang kurang umum digunakan - yaitu dengan membuatnya persis seperti tabel asli dan memasukkan data ke dalamnya.
